...
import com.bezkoder.spring.data.mongodb.authservice.service.JwtTokenProvider;
...
public class SecurityCredentialsConfig extends WebSecurityConfigurerAdapter {
    ...
    public CorsFilter corsFilter() {
        ...
        config.addAllowedOrigin("http://angular.harness-demo.site");
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://angular.harness-demo.site"));
